...
INSERT INTO "new_Exercise" ("answersJson", "createdAt", "fieldsJson", "id", "lessonId", "pdfData", "pdfName", "professorId", "status", "studentId", "title", "updatedAt") SELECT "answersJson", "createdAt", "fieldsJson", "id", "lessonId", "pdfData", "pdfName", "professorId", "status", "studentId", "title", "updatedAt" FROM "Exercise";
DROP TABLE "Exercise";
